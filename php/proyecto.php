<?php 
	...
	class Proyecto extends Conexion{
		...
		public function modificar($nombre_pro, $tipo_pro, $IDempleado, $fecha_in, $fecha_fin, $descripcion){
			$this->sentencia="UPDATE FROM usuario SET nombre_pro='$nombre_pro',tipo_pro='$tipo_pro', IDempleado='$IDempleado',fecha_in='$fecha_in',fecha_fin='$fecha_fin', descripcion='$descripcion' WHERE IDproyecto='id'";
