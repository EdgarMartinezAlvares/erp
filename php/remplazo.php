<?php 
	...
	class Remplazo extends Conexion{
		...
		public function modificar($IDmobiliario, $fecha, $costo, $descripcion){
			$this->sentencia="UPDATE FROM usuario SET IDmobiliario='$IDmobiliario',fecha='$fecha', costo='$costo', descripcion='$descripcion' WHERE IDremplazo='id'";
